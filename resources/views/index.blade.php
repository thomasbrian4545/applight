...
<link rel="shortcut icon" href="/frontend/images/logo-title.png">
...
<section class="banner" data-scroll-index='0'>
  ...
  <span class="svg-wave"> <img class="svg-hero" src="/frontend/images/applight-wave.svg"> </span> </section>
        ...
        <div class="section-content text-center">
          <div class="row">
            ...
            <div class="col-md-4 d-none d-md-block d-lg-block">
              <div class="feature-mobile"> <img src="/frontend/images/iphone-screen-with-shadow.png" class="img-fluid wow fadeInUp"/> </div>
            </div>
            <div class="col-md-4 col-sm-12">
              <div class="media single-feature wow fadeInUp" data-wow-delay="0.2s">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-4">
              <div class="team-detail wow bounce" data-wow-delay="0.2s"> <img src="/frontend/images/user1.jpg" class="img-fluid"/>
                <h4>Nitu Singh</h4>
                <p>Marketing Specialist</p>
              </div>
            </div>
            <div class="col-md-4">
              <div class="team-detail wow bounce" data-wow-delay="0.4s"> <img src="/frontend/images/user2.jpg" class="img-fluid"/>
                <h4>Yogesh Singh</h4>
                <p>CEO & Founder</p>
              </div>
            </div>
            <div class="col-md-4">
              <div class="team-detail wow bounce" data-wow-delay="0.6s"> <img src="/frontend/images/user3.jpg" class="img-fluid"/>
                <h4>Nisha Sharma</h4>
                <p>Web Developer</p>
              </div>
            </div>
          ...
          <div class="offset-md-2 col-md-8 col-sm-12">
            <div class="slider">
              <div class="slider-item">
                <div class="test-img"><img src="/frontend/images/user1.jpg" alt="Placeholder" width="157" height="157"></div>
              ...
              <div class="slider-item">
                <div class="test-img"><img src="/frontend/images/user3.jpg" alt="Placeholder" width="157" height="157"></div>
...
$(window).on("scroll",function () {
	...
	if(bodyScroll > 50){
	$('.navbar-logo img').attr('src','/frontend/images/logo-black.png');
	navbar.addClass("nav-scroll");

}else{
	$('.navbar-logo img').attr('src','/frontend/images/logo.png');
...
$(window).on("load",function (){
	...
	$('.navbar-logo img').attr('src','/frontend/images/logo-white.png');
	navbar.removeClass("nav-scroll");
	}
